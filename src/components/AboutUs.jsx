    ...
    return (
        <div>
         ...
         <div className='about-grid-container mt-10 w-full xl:mt-16'>
            ...
            <div className='p-6 py-16 pb-24 relative rounded-xl text-center text-pureWhite bg-lightOrange space-y-6 grid-col-span-2 flex flex-col items-center mb-10 xxs:px-6 lg:px-10 lg:text-left lg:items-start lg:space-y-8 lg:py-12 lg:mb-0 xl:py-12 xl:space-y-5 xl:px-12'>
