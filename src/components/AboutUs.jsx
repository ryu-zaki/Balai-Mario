        ...
        <div>
         ...
         <div className='about-grid-container mt-10 w-full xl:mt-16'>
            ...
            <div className='relative bg-lightOverlay cursor-pointer offers-min-height text-pureWhite flex justify-center rounded-xl overflow-hidden items-center about-card xl:overflow-visible'>
                <h3 className='sm:text-xl xl:text-2xl'>Special Events</h3>
            ...
            <div className='relative about-card cursor-pointer bg-lightOverlay offers-min-height text-pureWhite flex justify-center rounded-xl overflow-hidden items-center xl:overflow-visible'>
                <h3 className='sm:text-xl xl:text-2xl'>Quality Foods</h3>
            ...
            <div className='p-6 py-16 pb-24 relative rounded-xl text-center text-pureWhite bg-lightOrange space-y-6 grid-col-span-2 flex flex-col items-center mb-10 lg:text-left lg:items-start lg:space-y-8 lg:py-12 lg:mb-0 xl:py-10 xl:space-y-5 xl:px-10'>
                <h3 className='text-2xl font-bold sm:text-3xl xl:text-4xl'>Traditional and Modern</h3>
                <p className='xl:leading-8'>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Pellentesque. Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
                <button className='border-pureWhite button-scale-effect border-2 p-3 px-7 rounded-md text-pureWhite text-sm'>READ MORE</button>

                {/* Quote Message */}

                <div className='bg-pureWhite absolute border-lightOrange border rounded-xl w-11/12 text-darkBrown p-7 mx-auto bottom-0 translate-y-1/2 sm:w-4/5 lg:right-4 lg:w-60 lg:text-center lg:text-sm xl:bottom-1/2 xl:-right-16 xl:text-base xl:p-8 xl:px-10 xl:w-72 xl:leading-8'>
