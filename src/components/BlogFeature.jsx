        ...
        <div className='blog-feature-section my-32 flex flex-col items-center gap-8 lg:gap-20'>
            ...
            <div className='flex flex-col-reverse gap-10 md:flex-row lg:gap-16'>
               ...
               <div className='flex flex-col gap-16 xs:gap-20 sm:gap-28  md:justify-between md:gap-10 md:flex-grow lg:gap-2 2xl:gap-0'>
                ...
                <h2 className='title-font text-3xl text-center sm:text-5xl md:text-left md:text-5xl text-darkBrown md:pt-3 md:pr-40 lg:text-7xl lg:flex-grow 2xl:flex-shrink 2xl:text-6xl 2xl:pt-16'>Featuring Product</h2>
